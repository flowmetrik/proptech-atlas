...
## CRM & gestion des leads · CRM & lead management

_Capter, qualifier et travailler les leads acquéreurs, vendeurs et locataires._

| Produit | Éditeur | Marchés | Usage en immobilier |
|---|---|---|---|
| [Adapt Immo](data/tools/adapt-immo.yaml) | Adapt Immo | 🇫🇷 | Many French agencies run transaction and gérance side by side under the same carte professionnelle. Keeping both in one suite avoids the duplicate owner and property records that appear… |
...
_Piloter une vente de l'offre à l'acte — pièces, signature, conformité, commissions._
...
_Là où l'offre rencontre la demande en public — portails grand public, réseaux d'annonces et places de marché transactionnelles._
...
| [Zillow](data/tools/zillow.yaml) | Zillow Group | 🇺🇸 | For an agent, Zillow is rarely a listing tool and almost always an acquisition channel: buyer leads are sold by ZIP code share of voice through Premier Agent, and a seller conversation… |
| [Zumper](data/tools/zumper.yaml) | Zumper | 🇺🇸 | Landlords and managers list here to reach renters who search on mobile and expect to apply immediately. For smaller landlords the platform doubles as the application and screening… |

## Data de marché & intelligence immobilière · Market data & property intelligence

_Comparables, propriétaires, transactions, loyers, fréquentation et les jeux de données sur lesquels d'autres produits sont bâtis._
...
_Le logiciel qui met en forme et pousse un portefeuille d'annonces vers les portails et les réseaux partenaires._
...
## Sites d'agence & marketing immobilier · Agent websites & marketing

_Sites, recherche IDX, marque et campagnes pour agents et agences._
...
| [RentVision](data/tools/rentvision.yaml) | RentVision | 🇺🇸 | A multifamily operator facing rising vacancy on a specific floorplan uses RentVision's predictive advertising to redirect ad spend and traffic toward the at-risk unit type before it sits… |
...
_Estimation automatisée, comparables, pige propriétaires et pricing._
...
## Gestion locative résidentielle · Residential property management

_Baux, quittances, propriétaires, locataires, travaux et comptabilité mandant._
...
| [Brickwise AI](data/tools/brickwise-ai.yaml) | Brickwise | 🇺🇸 | A property manager receives a maintenance report by text: Alice diagnoses the problem with the tenant, dispatches an approved contractor, and tracks the case through to closing without… |
...
| [ShowMojo](data/tools/showmojo.yaml) | ShowMojo | 🇺🇸 | A property manager with vacant units lets ShowMojo publish and keep listings updated across rental sites, then hands off lead response and showing scheduling to the platform instead of… |
...
| [zInspector](data/tools/zinspector.yaml) | zInspector | 🇺🇸 | A property manager doing a move-in inspection walks the unit narrating what they see, and zAssistant turns that into a report with photos, conditions and comments rather than the manager… |

## Syndic & copropriété · HOA & condominium management

_Gérer l'immeuble en copropriété — budgets, AG, appels de fonds, travaux._
...
_Administration institutionnelle des baux, actifs et portefeuilles._
...
## Analyse d'investissement & underwriting · Investment analysis & underwriting

_Modéliser une opération, tester des scénarios, produire un mémo d'investissement._

| Produit | Éditeur | Marchés | Usage en immobilier |
|---|---|---|---|
| [ARGUS Enterprise](data/tools/argus-enterprise.yaml) | Altus Group | 🇺🇸 🇫🇷 | When an asset trades, the seller's broker sends an ARGUS file and the buyer re-underwrites in the same tool. That shared format is most of the value — assumptions are visible and… |
...
_Monter, tarifer et gérer le crédit immobilier._
...
_Recherche de titre, séquestre, actes et chaîne juridique de la mutation._

| Produit | Éditeur | Marchés | Usage en immobilier |
|---|---|---|---|
| [Docusign](data/tools/docusign.yaml) | Docusign | 🇺🇸 🇫🇷 | In the United States, the purchase agreement, addenda and disclosures are almost always signed here, often from inside dotloop, SkySlope or a forms platform rather than from Docusign's… |
...
| [Yousign](data/tools/yousign.yaml) | Yousign | 🇫🇷 | Mandates, lease agreements, offers and état des lieux are all signed remotely now, and the question that matters is evidentiary weight. eIDAS levels are not decoration: a qualified… |

## Construction & promotion · Construction & development

_Faisabilité, pilotage de projet, suivi de chantier et livraison._

| Produit | Éditeur | Marchés | Usage en immobilier |
|---|---|---|---|
| [Autodesk Construction Cloud](data/tools/autodesk-construction-cloud.yaml) | Autodesk | 🇺🇸 🇫🇷 | On a project designed in Revit, the coordination advantage is structural: clash detection runs on the federated model, the field team opens the same model on a tablet, and issues raised… |
| [Batappli](data/tools/batappli.yaml) | Batappli | 🇫🇷 | Its buyer is the established trade business that wants one supplier for commercial documents and books rather than a modern SaaS plus an accountant's package. The integrated accounting… |
...
_Interventions, prestataires, équipements et maintenance préventive._
...
_Données compteurs, trajectoire carbone, reporting réglementaire et plan de travaux._

| Produit | Éditeur | Marchés | Usage en immobilier |
|---|---|---|---|
| [Advizeo](data/tools/advizeo.yaml) | Advizeo by Setec | 🇫🇷 | Its difference from a pure reporting platform is the engineering behind it. Detecting that a building's heating runs at weekends is only useful if someone changes the schedule. Advizeo… |
...
## Expérience occupant & smart building · Tenant experience & smart building

_Applications occupants, accès, réservations, services et IoT du bâtiment._
...
| [PointCentral](data/tools/pointcentral.yaml) | Alarm.com | 🇺🇸 | A property manager automates move-in and move-out access on a portfolio of smart rental units through PointCentral instead of rekeying locks or coordinating in-person handoffs, and sets… |
| [Rently](data/tools/rently.yaml) | Rently | 🇺🇸 | A leasing agent lets a prospect self-tour a vacant unit outside office hours using Rently's smart-lock access control, without a staff member present for every showing. Once the prospect… |
...
| [Witco](data/tools/witco.yaml) | Witco | 🇫🇷 | Landlords and corporate occupiers use it as the single interface between the building and the people inside it. Practically, it consolidates what used to be five channels — an email for… |

## Flex office & coworking · Flex space & coworking

_Abonnements, réservation de postes, facturation et animation d'espaces flexibles._
...
_Channel manager, pricing, relation voyageur et ménage pour la courte durée._
...
_Photo, plans, visites virtuelles et home staging virtuel._
...
_Diagnostics obligatoires, informations acquéreur et dossiers réglementaires du bien._
...
_Vérifier un dossier, garantir le loyer, signer le bail._
...
| [SafeRent Solutions](data/tools/saferent-solutions.yaml) | SafeRent Solutions, LLC | 🇺🇸 | A property manager screening a rental applicant runs a SafeRent Solutions resident screening report to check credit, criminal and eviction history before approving a lease, while a… |
...
_Comptabilité mandant, reddition de comptes, commissions et back-office d'agence._
...
## Agents IA & automatisation · AI agents & automation

_Assistants LLM qui répondent, qualifient, rédigent et agissent sur le métier._
